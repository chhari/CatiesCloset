package com.example.yashnanavati.catiescloset.Login;
...
import com.example.yashnanavati.catiescloset.Base.BaseActivity;
...
public class MainActivity extends BaseActivity implements
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    FirebaseDatabase.getInstance()
                            ...
                            .push()
                            .setValue(new User(userEmail, userName));
                }
            }
    ...
    private void twitterLogin() {
        showProgress();
        mLoginButton.authorize(MainActivity.this, new Callback<TwitterSession>() {
            @Override

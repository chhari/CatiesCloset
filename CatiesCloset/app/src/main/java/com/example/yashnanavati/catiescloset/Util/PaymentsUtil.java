package com.example.yashnanavati.catiescloset.Util;
...
// Payment utility class object that allows payment api to send transactions to the firebase database.
// TO FUTURE DEVELOPER: need gateway api in order to complete transaction
    ...
    public static PaymentDataRequest createPaymentDataRequest(TransactionInfo transactionInfo) {
        PaymentMethodTokenizationParameters params =
                PaymentMethodTokenizationParameters.newBuilder()
                        ...
                        .addParameter("stripe:publishableKey", "pk_test_n3AFYRLU9HOOfn2aYTkUfHNH")

...
public class CardViewAdapter extends RecyclerView.Adapter<CardViewAdapter.DonationViewHolder> {
    ...
    public CardViewAdapter(Context context) {
        ...
        donation_list.add(new DonationNavPage("Donate Items", "Clothing and basic necessities ", R.drawable.kind_donation));
        donation_list.add(new DonationNavPage("Donate Cash", "Make an impact in the lives of 50,000 children ", R.drawable.girl_in_glasses_web));
